...
class SonaWindow(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.btn7 = QtWidgets.QPushButton('模型分类')
        ...
        self.btn7.setObjectName('left_button')

        self.btn1.setIcon(QtGui.QIcon(':/icons/文件.png'))
        ...
        self.btn7.setIcon(QtGui.QIcon('./icons/模型中心.png'))
        ...
        self.leftLayout.addWidget(self.btn7)
        ...
        QPushButton{border:none;font-size:16px;color:white;height:40px;font-weight:500;}  
        ...
        self.btn7.clicked.connect(self.select_Widget)
        ...
        self.rightWidget7 = QtWidgets.QWidget()
        self.rightWidget.addWidget(self.rightWidget7)
        ...
        self.rightWidget7.setObjectName('rightWidget7')
        ...
        self.rightWidget7.setAttribute(QtCore.Qt.WA_DeleteOnClose)
        ...
        # self.rightWidget1_up_layout.addWidget(self.filelabel)
        ...
        # self.filelabel2 = QtWidgets.QPushButton('Sona处理软件')
        ...
        self.rightWidget2_aislelabel.setStyleSheet('font-size:16px;')
        ...
        self.rightWidget2_samplelabel.setStyleSheet('font-size:16px;')
        ...
        self.trans_up_layout.addWidget(self.rightWidget2_aislelabel,0,2,1,1,QtCore.Qt.AlignRight)
        self.trans_up_layout.addWidget(self.rightWidget2_aisleline,0,3,1,1)
        self.trans_up_layout.addWidget(self.rightWidget2_samplelabel,1,2,1,1,QtCore.Qt.AlignRight)
        self.trans_up_layout.addWidget(self.rightWidget2_sampleline,1,3,1,1)

        self.filebtn = QtWidgets.QPushButton()
        self.filebtn.setText('选择文件')
        self.filebtn.setObjectName('filebtn')
        self.filebtn.setStyleSheet('margin-left:30px;')
        self.trans_up_layout.addWidget(self.filebtn,0,1,1,1)
        ...
        self.trans_up_layout.addWidget(self.filebtn2,1,1,1,1)
        self.filebtn2.setStyleSheet('margin-left:30px;')
        ...
        self.rightWidget2_aisleline.setFixedWidth(200)
        self.rightWidget2_sampleline.setFixedWidth(200)
        ...
        dataview.setWindowIcon(QtGui.QIcon('./label.ico'))
        ...
        # 窗口7设计
        self.rightWidget7_layout = QtWidgets.QGridLayout()
        self.rightWidget7.setLayout(self.rightWidget7_layout)
        self.rightWidget7_up_widget = QtWidgets.QWidget()
        self.rightWidget7_mid_widget = QtWidgets.QWidget()
        self.rightWidget7_down_widget = QtWidgets.QWidget()
        self.rightWidget7_layout.addWidget(self.rightWidget7_up_widget, 0, 0, 1, 10)
        self.rightWidget7_layout.addWidget(self.rightWidget7_mid_widget, 1, 0, 1, 10)
        self.rightWidget7_layout.addWidget(self.rightWidget7_down_widget, 2, 0, 10, 10)
        self.rightWidget7_up_widget_layout = QtWidgets.QHBoxLayout()
        self.rightWidget7_up_widget.setLayout(self.rightWidget7_up_widget_layout)
        self.rightWidget7_up_widget.setObjectName('rightWidget7_up_widget')
        self.rightWidget7_layout.setContentsMargins(0, 0, 0, 0)
        self.rightWidget7_mid_widget_layout = QtWidgets.QHBoxLayout()
        self.rightWidget7_mid_widget.setLayout(self.rightWidget7_mid_widget_layout)

        self.rightWidget7_up_widget_btn1 = QtWidgets.QPushButton(self.rightWidget7_up_widget)
        self.rightWidget7_up_widget_btn1.setText('选取文件夹,分类')
        self.rightWidget7_up_widget_layout.addWidget(self.rightWidget7_up_widget_btn1)
        self.rightWidget7_up_widget_btn1.clicked.connect(self.win7_select_file)

        self.rightWidget7_down_widget_layout = QtWidgets.QHBoxLayout()
        self.rightWidget7_down_widget.setLayout(self.rightWidget7_down_widget_layout)
        self.rightWidget7_down_widget_layout_w1 = QtWidgets.QTextEdit()
        self.rightWidget7_down_widget_layout.addWidget(self.rightWidget7_down_widget_layout_w1)
        self.rightWidget7_down_widget_layout_w1.setEnabled(False)

        self.rightWidget7.setStyleSheet('''
                #rightWidget7{background:white;
                border-top:1px solid darkGray;
                border-bottom:1px solid darkGray;
                border-right:1px solid darkGray;
                border-radius:10px;
                ...
                ''')
        self.rightWidget7_up_widget.setStyleSheet('''
                #rightWidget7_up_widget{
                background:#0A071A;
    ...
    def win7_select_file(self):
        ...
        if path:
            ...
            for i in range(len(files)):
                file = path + '/' + files[i]
                data = analysisdata.DataAnalysis(file, True)
                time = data.get_model_para()
                pre_y = train_class(np.array([time]))
                pre_ys.append(np.floor(pre_y[0].reshape(-1).clip(0, 2)))
            print('----',pre_ys)
            data_dic = {0: '带噪声音频', 1: '小孔渗流', 2:'水库渗流'}
            self.rightWidget7_down_widget_layout_w1.setText('')
            for i in range(len(files)):
    ...
    def sub_sample(self,line_filepath, line_outrate, outpath):
        print(line_outrate)
        if os.path.exists(line_filepath) and os.path.exists(outpath) and line_outrate != '':
            ok = batch_sample.resample(line_filepath, line_outrate, outpath)
            if ok == 'error':
                QtWidgets.QMessageBox.information(self, '信息提示', f'音频受损或者音频通道数大于2!!')
            else:
            ...
            self.rightWidget6_down_widget_layout_w1.setText('不存在路径或未设置采样率!')
    ...
    def resampleWav(self):
        ...
        line_filebtn = QtWidgets.QPushButton('输入')
        line_filebtn.clicked.connect(self.sample_batch_files)
        layout.addRow('输入文件路径：',line_filebtn)
        # line_filepath_out = QtWidgets.QLineEdit()
        line_filebtn_out = QtWidgets.QPushButton('输出')
        line_filebtn_out.clicked.connect(self.sample_files)
        layout.addRow('输出文件路径：',line_filebtn_out)
        line_outrate = QtWidgets.QLineEdit()
        layout.addRow('输出文件的采样率：',line_outrate)
        btn = QtWidgets.QPushButton('确定')
        layout.addWidget(btn)
        widget.setLayout(layout)
        btn.clicked.connect(lambda x: self.sub_sample(self.line_filepath, line_outrate.text(), self.line_filepath_out))
    ...
    def karmanwave(self):
        ...
        subwidget.setWindowIcon(QtGui.QIcon('./label.ico'))
        subwidget.setAttribute(QtCore.Qt.WidgetAttribute.WA_DeleteOnClose)
        subwidget.resize(500,600)
    ...
    def dataPaint(self):
        ...
        if aisle == 1:
            ...
            plt = self.dataPaint1(sigs,times,freqs,pows,ceps )
            gc.collect()
            
        else:
            item = data.get_data()
            plt = self.dataPaint2(item)
            gc.collect()
    ...
    def opensave(self):
        ...
        pages_lists = load_data['data'][row]
    ...
    def saveMenu(self,pos):
        ...
        if text == '保存' and item_type=='波形分析':
            ...
            if not json_len:
                ...
                json_data['data'] = []
                json_data['data'].append(data_list)
            ...
            if not json_len:
                ...
                json_data['头'].append(0)
                json_data['data'] = []
                json_data['data'].append(noise_file)
