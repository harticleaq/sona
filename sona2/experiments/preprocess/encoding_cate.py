...
if __name__ == '__main__':
    ...
    # label_col = 'Label'
    cate_col = []
    nume_col = ["sampling_points_per_second", "sampling", "track_number", "maximum_time", "minimum_time_domain", "median_time_domain",
     "time_domain_average" ,"time_domain_differential_peak", "time_domain_average_rectifier", "time_domain_variance", "time_domain_standard_deviation",
      "time_domain_kurtosis" ,"time_domain_of_skewness", "time_domain_root_mean_square", "time_domain_RMS_factor", "the_time_domain_peak_factor", 
      "time_domain_pulse_factor", "time_domain_margin_factor", "maximum_amplitude","minimum_amplitude","median_amplitude","average_amplitude",
      "peak_amplitude_difference", "peak_amplitude_threshold", "center_of_gravity_frequency","mean_square_frequency", 
      "root_mean_square_frequency", "frequency_variance", "frequency_standard_deviation", "maximum_power", "power_minimum_value", 
      "median_power", "power_average", "SNR", "bandwidth"]
    label_col = 'type'
